...
email=driver.find_element(By.ID, "userEmail").send_keys("rodrigo@gmail.com")
time.sleep(1)
...
direccion1=driver.find_element(By.ID, "currentAddress").send_keys("Casa1")
time.sleep(1)

direccion2=driver.find_element(By.ID, "permanentAddress").send_keys("Casa2")
time.sleep(1)
...
botonSubmit=driver.find_element(By.ID, "submit").click()
time.sleep(3)
